...
#' Storms events for this Water Year lasted anywhere from 
#' `r min(rain_storm_wateryear$duration_hr)` hours to 
#' `r max(rain_storm_wateryear$duration_hr)` hours.  While on average 
